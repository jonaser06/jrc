...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $dir; ?>bower_components/morris.js/morris.css">
  <link rel="stylesheet" href="<?php echo $dir; ?>bower_components/jvectormap/jquery-jvectormap.css">
  <link rel="stylesheet" href="<?php echo $dir; ?>bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  ...
  <link rel="stylesheet" href="<?php echo $dir; ?>css/estilos.css?v5">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="<?php echo $_SESSION['rol']; ?>" class="logo">
