            ...
            <div class="col-md-12">                
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable">
                                    ...
                                    <tbody class="table-body">
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input"> utilizar los EPP's respectivos </td>
                                            <td><input type="checkbox" class="form-check-input"> apagar el motor, aplicar freno de parqueo </td>
                                            <td><input type="checkbox" class="form-check-input"> desactivar el master switch </td>
                                            <td><input type="checkbox" class="form-check-input">extintor, cinta reflectiva y cono </td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input"> colocar tacos para evitar movimientos </td>
                                            <td><input type="checkbox" class="form-check-input">revisar la alarma de retroceso </td>
                                            <td><input type="checkbox" class="form-check-input">revisar estado de correa de seguridad </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="nav-tabs-custom" style="padding-bottom: 20px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">SISTEMA DE TRANSMISION</a></li>
                        <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">SISTEMA HIDRAULICO</a></li>
                        <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false">SISTEMA DE FRENOS</a></li>
                        <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false">SISTEMA ELECTRICO</a></li>
                        <li class=""><a href="#tab_6" data-toggle="tab" aria-expanded="false">SCHASIS</a></li>
                        <li class=""><a href="#tab_7" data-toggle="tab" aria-expanded="false">ENGRASE</a></li>
                    </ul>
